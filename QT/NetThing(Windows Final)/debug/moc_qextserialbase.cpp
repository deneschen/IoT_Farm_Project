...
**
** Created: Fri Apr 6 20:34:15 2012
...
static const char qt_meta_stringdata_QextSerialBase[] = {
    "QextSerialBase\0\0status\0dsrChanged(bool)\0"
};

const QMetaObject QextSerialBase::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QextSerialBase,
      qt_meta_data_QextSerialBase, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QextSerialBase::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QextSerialBase))
...
int QextSerialBase::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dsrChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
